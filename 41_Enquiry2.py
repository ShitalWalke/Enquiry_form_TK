...
class Register:
    def __init__(self, root):
        ...
        title = Label(frame1, text="ENQUIRY HERE ", font=("times new roman", 20, "bold"), bg="white", fg="green").place(
            x=50, y=30)
        ...
        # Email
        l_email = Label(frame1, text="Email", font=("times new roman", 15, "bold"), bg="white", fg="gray").place(x=365,
                                                                                                                 y=160)
        self.txt_email = Entry(frame1, font=("times new roman", 15), bg="lightgray")
        self.txt_email.place(x=370, y=190, width=250)

        # Security Question
        s_question = Label(frame1, text="Security Question: ", font=("times new roman", 15, "bold"), bg="white",
                           fg="gray").place(x=50, y=225)
        ...
        # Answer
        s_answer = Label(frame1, text="Answer", font=("times new roman", 15, "bold"), bg="white", fg="gray").place(
            x=365, y=225)
        ...
        self.chk = IntVar()
        chk = Checkbutton(frame1, text="I agree to the terms and conditions", variable=self.chk, onvalue=1, offvalue=0,
                          bg="White", font=("times new roman", 12)).place(x=50, y=380)

        # Submit Button
        self.btn_smb = Button(frame1, text="Submit", font=("times new roman", 15, "bold"), bg="green", fg="gray",
